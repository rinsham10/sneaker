      ...
      <div className="sticky top-0 w-full h-screen overflow-hidden z-30 pointer-events-none">
        ...
        {!loading && (
          <div className="relative z-20 w-full h-full flex items-center justify-center px-4 md:px-6">
            ...
            >
              <h1 className="text-[18vw] md:text-[12vw] font-black leading-none text-white tracking-tighter text-glow">DUNK <span className="opacity-60">LOW</span></h1>
            ...
            >
              <h2 className="text-6xl sm:text-8xl md:text-[15vw] font-black text-white italic tracking-tighter mix-blend-overlay opacity-80 uppercase">GRIP</h2>
